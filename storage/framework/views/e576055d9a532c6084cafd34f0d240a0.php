...
<?php $__env->startSection('title', 'Ketersediaan Ruang'); ?>
<?php $__env->startSection('page_title', 'Ketersediaan Ruang'); ?>
<?php $__env->startSection('page_subtitle', 'Lihat ruang kosong dan detail fasilitas ruang kelas'); ?>
        ...
        <div class="room-card bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden"
            ...
            <div class="p-5">
                <div class="flex justify-between items-start mb-3">
                    <div>
                        <h3 class="font-bold text-lg"><?php echo e($room['name']); ?></h3>
                        <p class="text-sm text-slate-500">Kapasitas <?php echo e($room['capacity']); ?> orang</p>
                    </div>

                    <?php if($room['status'] === 'available'): ?>
                        <span class="px-3 py-1 rounded-full bg-emerald-100 text-emerald-700 text-xs font-bold">Tersedia</span>
                    <?php elseif($room['status'] === 'used'): ?>
                ...
                <p class="text-sm text-slate-600 mb-5">
                    Fasilitas: <?php echo e($room['facility']); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Kara\Kuliah\Tugas Kuliah\Semester 4\Pemrograman Berbasis Web\Project\PROJECT\resources\views/rooms/index.blade.php ENDPATH**/ ?>