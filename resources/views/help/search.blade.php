...
<div class="max-w-5xl mx-auto font-sora space-y-6">
    ...
    <div class="fade-up delay-1">
        ...
        <div class="mb-6">
            <h2 class="text-lg font-bold text-slate-800 mb-4">📄 Artikel Terkait ({{ $articles->count() }})</h2>
        ...
        <div>
            <h2 class="text-lg font-bold text-slate-800 mb-4">❓ FAQ Terkait ({{ $faqs->count() }})</h2>
            <div class="space-y-3">
                @foreach($faqs as $faq)
