...
@section('title', 'Tambah Ruang - Admin')
@section('page_title', 'Tambah Ruang Baru')
@section('page_subtitle', 'Isi data ruangan dengan lengkap')
        ...
        <form action="{{ route('admin.rooms.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="number" name="lantai" value="{{ old('lantai', 1) }}"
                ...
                <div>
                    ...
                    <input type="time" name="jam_buka" value="{{ old('jam_buka', '07:00') }}"
                ...
                <div>
                    ...
                    <input type="time" name="jam_tutup" value="{{ old('jam_tutup', '21:00') }}"
                ...
                <div>
                    ...
                    <input type="number" name="max_durasi_jam" value="{{ old('max_durasi_jam', 4) }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-xs text-slate-400 mt-1">Maksimal 2MB. Format: JPG, PNG</p>
                    @error('foto')
                    <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="deskripsi" rows="4"
                              ...
                              placeholder="Deskripsi singkat ruangan...">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                    <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                    @enderror
                </div>
